...
class State:
  ...
  def initialize(self,
    ...
    if jaxlib_extension_version >= 358:
      # In jaxlib version 358, the heartbeat_timeout argument replaced the old
    ...
    if process_id == 0:
      ...
      self.service = _jax.get_distributed_runtime_service(
          coordinator_bind_address, num_processes, **heartbeat_kwargs)
    ...
    self.client = _jax.get_distributed_runtime_client(
        ...
        use_compression=True, **heartbeat_kwargs)
