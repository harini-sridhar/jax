...
def least_replicated_expression(
  ...
  """Returns the least replicated expression out of many expressions.
  ...
  Returns:
    ...
    all the other expressions in the sequence, then that constant expression is
...
def most_replicated_expression(
  ...
  """Returns the most replicated expression out of many expressions.
